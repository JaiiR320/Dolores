        ...
        <div className="w-3/4 mx-auto pt-8 text-center">
          ...
          <div>
            <p className="text-lg md:text-xl">
              <mark className="bold-words">Dolores</mark> is a restaurant located in
              the <mark className="bold-words">Fox Point neighborhood</mark> on the
              east side of Providence. Dolores features contemporary and regional
              Mexican cuisine from the
              <mark className="bold-words"> Mixteca</mark> region of Puebla and Oaxaca,
              drawing inspiration from its many types of Moles, sauces and stews.
              The beverage program boasts it&apos;s strength in
              <mark className="bold-words"> México&apos;s artisanal agave distillates</mark>,
      ...
      <div className="container mx-auto pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 text-center pb-8 gap-8">
          ...
          <div className="social pb-8">
            ...
            >
              <svg className="social-icon facebook" viewBox="0 0 24 24" fill="currentColor">
            ...
            >
              <svg className="social-icon instagram" viewBox="0 0 24 24" fill="currentColor">
