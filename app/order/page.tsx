    ...
    <>
      ...
      <div className="container mx-auto pb-8">
        <div className="w-3/4 mx-auto pt-8 text-center">
          <div>
            <h1 className="text-primary text-4xl md:text-5xl font-bold">Online Ordering</h1>
          </div>
          <hr className="border-t-2 border-[#b4b4b4] w-[95%] mt-1 mb-4" />
          <div>
            <p className="text-lg md:text-xl">
              Enjoy an authentic mexican meal in the comfort of your
              home! With an arrangement of our signature salsas,
              tasty beverage mixes, and traditional mexican grub, you
              can bring the Mixteca region to the comfort of your own home!
            </p>
          </div>
        </div>
          ...
          <div>
            ...
            <p className="mt-6">
              <button
                ...
                onClick={() => window.open('https://app.upserve.com/b/dolores/gift-card', '_self')}
              >
                Get Here
              </button>
            </p>
